...
//nav
const navbar = document.querySelectorAll(".menunav .category");
...
// }
///demo
const categoryCandy = document.querySelector("[data-id='candy']");
const categoryHambuger = document.querySelector("[data-id='hambuger']");
const categoryIceCream = document.querySelector("[data-id='ice-cream']");
const categoryHotdog = document.querySelector("[data-id='hotdog']");
//all
const allCategory = document.querySelector("[data-id='all']");
const allData = document.querySelectorAll(".box");
const showAll = () => {
  document
    .querySelectorAll(".box")
    .forEach((el) => el.classList.remove("hide-category"));
};
allCategory.addEventListener("click", (e) => {
  showAll();
});
//candy only
const candys = document.querySelectorAll(".box:not(.candy)");
categoryCandy.addEventListener("click", (e) => {
  showAll();
  for (let elem of candys) {
    elem.classList.add("hide-category");
  }
});
//ham only
const hambugers = document.querySelectorAll(".box:not(.hambuger)");
categoryHambuger.addEventListener("click", (e) => {
  showAll();
  for (let elem of hambugers) {
    elem.classList.add("hide-category");
  }
});
// ice only
const iceCreams = document.querySelectorAll(".box:not(.ice-cream)");
categoryIceCream.addEventListener("click", (e) => {
  showAll();
  for (let elem of iceCreams) {
    elem.classList.add("hide-category");
  }
});
//hotdog only
const hotdogs = document.querySelectorAll(".box:not(.hotdog)");
categoryHotdog.addEventListener("click", (e) => {
  showAll();
  for (let elem of hotdogs) {
    elem.classList.add("hide-category");
  }
});
